...
local options = 
{
    ...
    {
      {
        ...
        desc = 'The player will lose only after all his units are dead)\n',
      },
      {
        key  = '3',
        name = 'Never ends',
...

  {
    key    = 'MaxUnits',
    name   = 'Max units',
    desc   = 'Maximum number of units a player can have on the field simultaneously, does not count loaded blobs.',
    type   = 'number',
    def    = 10000,
    min    = 10000,
    max    = 10000,
